...
public class CheckIn_CheckOut_Date 
{
	public static void main(String args[]) throws InterruptedException
	{
		...
		//Step-I: Declare 2 Variable-->(1) Month and Year (2)Date	
		String Expected_Out_Month = "November 2023";
		String Expected_Out_date = "20";
		...
		while(true)
		{
	    	...
	    	if(Expected_Out_Month.equals(Actual_Month))
	    	{
	    		break;
	    	}
	    	else
		...
		//Get all the dates
		List<WebElement> All_Month_Dates = driver.findElements(By.xpath("(//table[@class='eb03f3f27f']//tr//td"));
		//System.out.println(All_Dates);
		
		for(WebElement Date:All_Month_Dates)
		{
			String Actual_Date = Date.getText();
			System.out.println(Actual_Date);
			
			if(Expected_Out_date.equals(Actual_Date))
			{
				Date.click();
				break;
			}
